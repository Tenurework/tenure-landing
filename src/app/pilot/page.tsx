...
const STATUS: { k: string; v: string }[] = [
  ...
  */
  ...
  {
    k: "Who would sign",
    v: "The pilot term runs on a written scope agreed with the office rather than a purchase order. When pricing begins it is a separate written agreement, signed in advance.",
  },
];
...
const HANDLING: { t: string; d: string }[] = [
  {
    t: "Who can read what",
...
, which is a description of how we work, not a service
                      ...
                      <p className="mt-3 max-w-3xl text-body leading-relaxed text-text-secondary measure">
                        The people who wrote the code are the people who answer, and
                        what your office needs shapes what gets built next. Response
                        times and a named escalation contact are agreed in the written
                        scope, where they belong, rather than asserted on a web page.
                      </p>
                ...
                {
                  key: "data",
                  title: "How data, access and approvals work",
                  blurb:
                    "The entries a pilot decision actually turns on.",
                  tally: [{ label: `${HANDLING.length} areas` }],
                  children: (
                    <>
                      <p className="max-w-3xl text-body leading-relaxed text-text-secondary measure">
                        The parts an office and its security reviewer ask about
                        first.{" "}
                        <a
                          href="/trust"
                        ...
                        carries the full control register with its sources.
                      </p>
